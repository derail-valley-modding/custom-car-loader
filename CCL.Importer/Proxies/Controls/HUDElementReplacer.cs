    ...
    internal class HUDElementReplacer : Profile
    {
        public HUDElementReplacer()
        {
            ...
            CreateMap<LocoIndicatorReaderProxy, LocoIndicatorReader>().AutoCacheAndMap()
                ...
                .ForMember(d => d.transmissionOil, o => o.MapFrom(s => Mapper.GetFromCache(s.transmissionOil)))
                ...
                .ForMember(d => d.chestPressure, o => o.MapFrom(s => Mapper.GetFromCache(s.chestPressure)))
                ...
                .ForMember(d => d.cylCocksPopped, o => o.MapFrom(s => Mapper.GetFromCache(s.cylCocksPopped)));
            CreateMap<LocoLampReaderProxy, LocoLampReader>().AutoCacheAndMap()
                .ForMember(d => d.fuel, o => o.MapFrom(s => Mapper.GetFromCache(s.fuel)))
                .ForMember(d => d.battery, o => o.MapFrom(s => Mapper.GetFromCache(s.battery)))
                .ForMember(d => d.oil, o => o.MapFrom(s => Mapper.GetFromCache(s.oil)))
                .ForMember(d => d.automaticLubricator, o => o.MapFrom(s => Mapper.GetFromCache(s.automaticLubricator)))
                .ForMember(d => d.manualLubricator, o => o.MapFrom(s => Mapper.GetFromCache(s.manualLubricator)))
