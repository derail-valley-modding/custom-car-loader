...
namespace CCL.Importer
{
    internal static class AutoMapperExtensions
    {
        ...
        public static IMappingExpression<TSource, TDestination> CacheAndProcessProxyAutomatically<TSource, TDestination>(this IMappingExpression<TSource, TDestination> cfg)
